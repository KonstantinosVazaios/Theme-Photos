...
@section('title', $mail->created_at->format('d-m / G:i'))
...
<h1 style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; color: #3d4852; font-size: 18px; font-weight: bold; margin-top: 0; text-align: left;">Homu Sushi Bar - Φόρμα Επικοινωνίας</h1>
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; font-size: 16px; line-height: 1.5em; margin-top: 0; text-align: left;">Καινούργιο μήνυμα από την φόρμα επικοινωνίας</p>
...
<b>Όνομα:</b> {{$mail->name}}<br>
<b>Τηλέφωνο:</b> {{$mail->telephone}}<br>
<b>Email:</b> {{$mail->email}}<br>
<b>Μήνυμα:</b> {{$mail->message}}<br>
...
<form method="post">
  @csrf
  @method('DELETE')
  <button style="height: 30px; background: #C63333; border:none; font-size: 18px; color: #fff" type="submit" class="btn-btn-primary">ΔΙΑΓΡΑΦΗ</button>
</form>
</td>
</tr>
</table>
...
<p style="box-sizing: border-box; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, Helvetica, Arial, sans-serif, 'Apple Color Emoji', 'Segoe UI Emoji', 'Segoe UI Symbol'; position: relative; line-height: 1.5em; margin-top: 0; color: #b0adc5; font-size: 12px; text-align: center;">© 2020 HOMU SUSHI BAR. All rights reserved.</p>
