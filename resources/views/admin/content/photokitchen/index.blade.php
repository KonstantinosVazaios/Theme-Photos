...
<div>
  <div class="col-md-12 mt-3 mb-3">
      <div class="card">
          <div class="card-body">
            <form method="post" action="/admin/homu/content/photokitchen/{{$photo->id}}" enctype="multipart/form-data">
              @csrf
              @method('PATCH')
      ...
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-striped">
            ...
            <tbody>
              <tr>
                <td style="text-align: left; vertical-align: middle; font-size: 18px"><a href="/storage/{{$photo->image_path}}"><img src="/storage/{{$photo->image_path}}" style="width: 100%; height: 100%;"src=""></a></td>
              </tr>
            </tbody>
          </table>
