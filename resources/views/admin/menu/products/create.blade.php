...
@section('title', 'Δημιουργία Προϊόντος')
        ...
        <div class="col-md-9">
            <div class="card">
                <div class="card-body mt-1 mb-3">
                  <form action="/admin/homu/product/create" enctype="multipart/form-data" method="post">
                    @csrf
                    <div class="form-group">
                      <label class="mb-4" for="exampleFormControlSelect1"><b>Επιλογή Κατηγορίας</b></label>
                    ...
                    <button type="submit" class="btn btn-primary mt-3">Δημιουργία Προϊόντος</button>
                  </form>
                </div>
            </div>
        </div>
